...
- URL: https://huggingface.co/spaces/Chris4K/NamedEntityRecognitionTool
- SDK: gradio
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/NamedEntityRecognitionTool/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/NamedEntityRecognitionTool
